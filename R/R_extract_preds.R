...
#Read in point data
pnts <- st_read("YOUR POINT DATASET")

#Define output directory
#Will need to set your own paths
outDir <- "YOUR OUTPUT DIRECTOR"
pntDir = "YOUR POINT OUTPUT DIRECTORY"
...
#Saving the raster to disk in not necessary if you are just extracting the values at point locations
#writeRaster(topo_stack, paste0(outDir, "NAME YOUR OUTPUT RASTER"), overwrite=TRUE)

pntsExt <- extract(topo_stack, pnts)
...
write.csv(pntsExt, paste0(pntDir, "NAME YOUR OUTPUT TABLE"))
